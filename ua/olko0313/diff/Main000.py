...
if __name__ == '__main__':
    ...
    for x in fdiff[30:32]:
        tree1 = etree.parse(dir_1+x)
        tree2 = etree.parse(dir_2+x)
        print(x)
        print(tree2.xpath('.//param[@attr_id = "9135697576213471030"]'))
        tree2.xpath('.//param[@attr_id = "9135697576213471030"]')[0].attrib['_attr_name'] = "olko0313" 
        print(etree.tostring((tree2.xpath('.//param[@attr_id = "9135697576213471030"]')[0])))
        tree2.write(dir_2+x)
